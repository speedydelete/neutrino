...
static any* add_any_any(any* x, any* y) {
    if (x->type == STRING_TAG || y->type == STRING_TAG) {
        return create_any_from_string(strcat(cast_any_to_string(x), cast_any_to_string(y)));
    } else {
...
static inline char* add_undefined_string(void* x, char* y) {return strcat("undefined", y);}
...
static inline char* add_undefined_array(void* x, array* y) {return strcat("undefined", array_to_string(y));}
...
static inline char* add_null_string(void** x, char* y) {return strcat("null", y);}
...
static inline char* add_null_array(void** x, array* y) {return strcat("null", array_to_string(y));}
static inline any* add_null_any(void** x, any* y) {return y->type == STRING_TAG ? create_any_from_string(strcat("null", y->string)) : create_any_from_number(cast_to_number(y));}
...
static inline char* add_boolean_string(bool x, char* y) {return strcat(cast_to_string(x), y);}
...
static inline char* add_boolean_array(bool x, array* y) {return strcat(x ? "true" : "false", array_to_string(y));}
static inline any* add_boolean_any(bool x, any* y) {return y->type == STRING_TAG ? create_any_from_string(strcat(x ? "true" : "false", y->string)) : create_any_from_number(cast_to_number(y));}
...
static inline char* add_number_string(double x, char* y) {return strcat(number_to_string(x, 10), y);}
...
static inline char* add_number_array(double x, array* y) {return strcat(number_to_string(x, 10), array_to_string(y));}
static inline any* add_number_any(double x, any* y) {return y->type == STRING_TAG ? create_any_from_string(strcat(number_to_string(x, 10), y->string)) : create_any_from_number(x + cast_to_number(y));}

static inline char* add_string_undefined(char* x, void* y) {return strcat(x, "undefined");}
static inline char* add_string_null(char* x, void** y) {return strcat(x, "null");}
static inline char* add_string_boolean(char* x, bool y) {return strcat(x, y ? "true" : "false");}
static inline char* add_string_number(char* x, double y) {return strcat(x, number_to_string(y, 10));}
static inline char* add_string_string(char* x, char* y) {return strcat(x, y);}
static inline char* add_string_symbol(char* x, symbol y) {return strcat(x, "Symbol");}
static inline char* add_string_object(char* x, object* y) {return strcat(x, cast_any_to_string(object_to_primitive(y)));}
static inline char* add_string_array(char* x, array* y) {return strcat(x, array_to_string(y));}
static inline char* add_string_any(char* x, any* y) {return strcat(x, cast_any_to_string(y));}
...
static inline char* add_symbol_string(symbol x, char* y) {return strcat("Symbol", y);}
...
static inline char* add_symbol_array(symbol x, array* y) {return strcat("Symbol", array_to_string(y));}
...
static inline char* add_array_undefined(array* x, void* y) {return strcat(array_to_string(x), "undefined");}
static inline char* add_array_null(array* x, void** y) {return strcat(array_to_string(x), "null");}
static inline char* add_array_boolean(array* x, bool y) {return strcat(array_to_string(x), y ? "true" : "false");}
static inline char* add_array_number(array* x, double y) {return strcat(array_to_string(x), number_to_string(y, 10));}
static inline char* add_array_string(array* x, char* y) {return strcat(array_to_string(x), y);}
static inline char* add_array_symbol(array* x, symbol y) {return strcat(array_to_string(x), "Symbol");}
...
static inline char* add_array_array(array* x, array* y) {return strcat(array_to_string(x), array_to_string(y));}
static inline char* add_array_any(array* x, any* y) {return strcat(array_to_string(x), cast_any_to_string(y));}

static inline any* add_any_undefined(any* x, void* y) {return x->type == STRING_TAG ? create_any_from_string(strcat(x->string, "undefined")) : create_any_from_number(NaN);}

...
export type Type = Any | Unknown | Never | Undefined | Void | Null | Boolean | Number | String | Symbol | BigInt | ObjectType | Union | Intersection | Generic | TypeVar | Infer | Conditional;
...
export const union: TypeFactory<Union, (Type | Type[])[]> = createTypeFactory('union', function(...types: (Type | Type[])[]) {
